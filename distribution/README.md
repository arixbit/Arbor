...
```sh
brew tap arixbit/arbor
brew install --cask arbor
```
...
Homebrew only downloads and copies the app; it cannot make an unsigned app
Apple-trusted. Users may still need Finder's **Open** or the app-specific
